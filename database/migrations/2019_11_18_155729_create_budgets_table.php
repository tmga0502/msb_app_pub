...
class CreateBudgetsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('budgets', function (Blueprint $table) {
            ...
            $table->string('R_other1_remark', 255)->nullable()->default(null);
            $table->json('R_other2')->nullable()->default(null);
            $table->string('R_other2_remark', 255)->nullable()->default(null);
            $table->json('R_other3')->nullable()->default(null);
            $table->string('R_other3_remark', 255)->nullable()->default(null);
            ...
            $table->string('S_other1_remark', 255)->nullable()->default(null);
            $table->json('S_other2')->nullable()->default(null);
            $table->string('S_other2_remark', 255)->nullable()->default(null);
            $table->json('S_other3')->nullable()->default(null);
            $table->string('S_other3_remark', 255)->nullable()->default(null);
