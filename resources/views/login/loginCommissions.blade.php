...
<div id="wrapper">
    @include('side_menu')
<div id="page-wrapper">
    <div style="padding: 20px 20px 50px 20px;min-height:900px;">
        <div id="tab-general">
                ...
                <div class="page-form" style="margin: 100px auto;">
                    <div class="panel panel-blue">
                        <div class="panel-body pan">
                            <form method="POST" action="{{ route('login_commissions') }}" class="form-horizontal">
                            <div class="form-body pal">
                                ...
                                <div class="form-group mbn">
                                    <div class="col-xs-12" style="text-align:right;">
                                            <button type="submit" name="commission" class="btn btn-default">ログイン</button>
                                    </div>
                                </div>
                                {{ csrf_field() }}
                                </form>
