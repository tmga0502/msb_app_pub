...
<head>
    ...
    <!-- 業務ツール用css -->
    <link type="text/css" rel="stylesheet" href="{{ url('/') }}/css/commissions.css">

    <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="{{ url('/') }}/js/commissions-query.js"></script>

</head>

<body>
  @if(Auth::check())
    @include('commissions.topbar')
  @else
  ...
  @yield('content')
    ...
    <script type="text/javascript">
        var jsArray=JSON.parse('<?php echo $csvArray; ?>');//jsonをparseしてJavaScriptの変数に代入
    </script>
    @endif
    <script src="{{ url('/') }}/js/commissions-main.js"></script>
