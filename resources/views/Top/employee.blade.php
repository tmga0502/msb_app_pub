            ...
            <div class="panel panel-blue">
                <div class="panel-body pan">
                    ...
                    <div class="form-body pal">
                        ...
                        <button type="button" class="btn btn-danger btn-lg" style="width:100%;" disabled>売上管理(準備中)</button>
                        <br><br>
                        </a>
                        ...
                        <!-- 経費登録 -->
                        <a href="#">
                        <button type="button" class="btn btn-dark btn-lg" style="width:100%;" disabled>経費登録(準備中)</button>
                        <br><br>
                        </a>

                        <!-- 労働時間管理 -->
                        <a href="#">
                        <button type="button" class="btn btn-dark btn-lg" style="width:100%;" disabled>労働時間管理(準備中)</button>
                        <br><br>
                        </a>
