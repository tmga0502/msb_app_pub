  ...
  <div id="page-wrapper">
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
      <div class="page-header pull-left">
        <div class="page-title"> 17口座入金チェック</div>
      </div>
      <div class="clearfix">
      </div>
    </div>
              ...
              <nav role="navigation" class="navbar navbar-default">
                <div class="container-fluid">
                  ...
                  <div id="bs-example-navbar-collapse-2" class="collapse navbar-collapse">
                    <form action="{{ route('commissions.searchCSV17') }}" method="POST" role="search" class="navbar-form navbar-left">
                      @csrf
                ...
                <div class="panel-body">
                  ...
                  <table class="table table-hover table-borde table-sm">
                    ...
                    <tbody>
                      ...
                      <form action="{{ route('commissions.update_csv17') }}" method="POST" name="form1">
                        @csrf
                        @if($now_month == 1)
                        ...
                        <tr>
                          ...
                          <!-- 金額 -->
                          <td>
                            <input type="text" class="price" style="text-align:right;" name="price[{{ $csv['id'] }}]" value="{{ number_format($csv['price']) }}" readonly>
                          </td>
                          <!-- 名目 -->
                          <td>
                          <!-- SuperUserなら -->
                            @if(Auth::user()->superUser === 1)
                            <select class="form-control nominal sbChange" name="nominal[{{ $csv['id'] }}]"  id="super">
...
広告料　　：<input type="number" id="input3" size="10" maxlength="10" style="text-align:right;">円<br><br>
