<tbody>
  @foreach( $indiviListManage as $list)
  <tr id="indivi_td_tr">
  ...
  <tr id="indivi_sum_tr" style="background-color:#FFFF99;">
    ...
    <td colspan=5></td>
    <td id="sum_manage_bro" style="text-align:right;">¥{{ number_format($manageSum[0]) }}</td>
    <td></td>
    <td id="sum_manage_ad" style="text-align:right;">¥{{ number_format($managetSum[1]) }}</td>
    <td></td>
    <td id="sum_manage_ap" style="text-align:right;">¥{{ number_format($managetSum[2]) }}</td>
    <td></td>
    <td id="sum_manage_oi" style="text-align:right;">¥{{ number_format($managetSum[3]) }}</td>
    <td></td>
    <td id="sum_manage_out" style="text-align:right;">¥{{ number_format($manageSum[4]) }}</td>
    <td id="sum_manage_sale" style="text-align:right;">¥{{ number_format($manageSum[5]) }}</td>
    <td id="sum_manage_notax" style="text-align:right;">¥{{ number_format($manageSum[6]) }}</td>
    <td colspan=4></td>
    @foreach( $manageSum[7] as $sum)
    <td></td>
    <td style="text-align:right;">¥{{ round($sum) }}</td>
    @endforeach
    <td></td>
    <td style="text-align:right;">¥{{ number_format($manageSum[8]) }}</td>
  <tr>
</tbody>
</div>
