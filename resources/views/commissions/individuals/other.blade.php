<tbody>
  @foreach( $indiviListOther as $list)
  <tr id="indivi_td_tr">
  ...
  <tr id="indivi_sum_tr" style="background-color:#FFFF99;">
    <td style="text-align:center;">その他小計</td>
    <td colspan=5></td>
    <td id="sum_other_bro" style="text-align:right;">¥{{ number_format($otherSum[0]) }}</td>
    <td></td>
    <td id="sum_other_ad" style="text-align:right;">¥{{ number_format($otherSum[1]) }}</td>
    <td></td>
    <td id="sum_other_ap" style="text-align:right;">¥{{ number_format($otherSum[2]) }}</td>
    <td></td>
    <td id="sum_other_oi" style="text-align:right;">¥{{ number_format($otherSum[3]) }}</td>
    <td></td>
    <td id="sum_other_out" style="text-align:right;">¥{{ number_format($otherSum[4]) }}</td>
    <td id="sum_other_sale" style="text-align:right;">¥{{ number_format($otherSum[5]) }}</td>
    <td id="sum_other_notax" style="text-align:right;">¥{{ number_format($otherSum[6]) }}</td>
    <td colspan=4></td>
    @foreach( $otherSum[7] as $sum)
    <td></td>
    <td style="text-align:right;">¥{{ round($sum) }}</td>
    @endforeach
    <td></td>
    <td style="text-align:right;">¥{{ number_format($otherSum[8]) }}</td>
  <tr>
</tbody>
</div>
